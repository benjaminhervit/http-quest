...
def createGateLevel():
    ...
    level.set_quest(f'To open {R.THE_GATE.value} you must DELETE it - but you have not taken your pre-workout shake today. Instead, you must [answer] an riddle in old forgotten language: "Speak friend and enter..."')
...
def createThroneLevel():
    ...
    level.set_quest(f'Standing in fron of the throne you see the CRUDe Crown and you know what you must do. But how?')
    ...
    level.set_victory_message_template('HOW THE FUCK SHOULD I KNOW SOMETHING LIKE THAT?! JaSON exlaims when he hears your question.')
    return level
...
def createCrownLevel():
    ...
    level.set_quest('In case JaSONs immature outburst made you forget the setting: Standing in fron of the throne you see the CRUDe Crown and you know what you must do. But how?')
