...
from game.levels.level_enum import LevelEnum as LE, LevelState as LS
...
class QuestDB:
    ...
    CREATE TABLE IF NOT EXISTS teams
        ...
        {LE.REGISTRATION.value} TEXT DEFAULT 'INACTIVE' CHECK ({LE.REGISTRATION.value} in ({LS.INACTIVE.value}, {LS.WELCOME.value}, {LS.ACTIVE.value}, {LS.COMPLETED.value})),
        {LE.THE_TEST.value} TEXT DEFAULT 'INACTIVE' CHECK ({LE.REGISTRATION.value} in ({LS.INACTIVE.value}, {LS.WELCOME.value}, {LS.ACTIVE.value}, {LS.COMPLETED.value})),
        {LE.THE_MONSTER.value} TEXT DEFAULT 'INACTIVE' CHECK ({LE.REGISTRATION.value} in ({LS.INACTIVE.value}, {LS.WELCOME.value}, {LS.ACTIVE.value}, {LS.COMPLETED.value})),
        {LE.THE_GATE.value} TEXT DEFAULT 'INACTIVE' CHECK ({LE.REGISTRATION.value} in ({LS.INACTIVE.value}, {LS.WELCOME.value}, {LS.ACTIVE.value}, {LS.COMPLETED.value})),
        {LE.THE_THRONE_ROOM.value} TEXT DEFAULT 'INACTIVE' CHECK ({LE.REGISTRATION.value} in ({LS.INACTIVE.value}, {LS.WELCOME.value}, {LS.ACTIVE.value}, {LS.COMPLETED.value})),
        {LE.THE_CROWN.value} TEXT DEFAULT 'INACTIVE' CHECK ({LE.REGISTRATION.value} in ({LS.INACTIVE.value}, {LS.WELCOME.value}, {LS.ACTIVE.value}, {LS.COMPLETED.value})),
