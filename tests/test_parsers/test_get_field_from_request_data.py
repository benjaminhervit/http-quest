...
from app.utils.parser_utils import get_field_from_request_data, get_query, get_headers, get_json
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # headers
        ("/", "", "GET", None, None, {'authorization': 'test'}, get_headers, 'authorization', 'test'),
        ("/", "", "GET", None, None, {'Authorization': 'test'}, get_headers, 'authorization', 'test'),
        ("/", "", "GET", None, None, {'Authorization': 'test'}, get_headers, 'Authorization', 'test'),
        ("/", "", "GET", None, None, {'abs': 'test'}, get_headers, 'Authorization', ParsingError),
        ("/", "", "GET", None, None, None, get_headers, 'Authorization', ParsingError),
        # json
        ("/", "", "GET", {'foo': 'bar'}, None, None, get_json, 'foo', 'bar'),  #  valid
        ("/", "", "GET", {'foo': 'bar', 'a': 'b'}, None, None, get_json, 'a', 'b'),  #  valid
        ("/", "", "GET", {"foo": None}, None, None, get_json, 'foo', ParsingError),  #  wrong json
        ("/", "", "GET", '{"foo": bar}', None, None, get_json, 'foo', TypeError),  #  wrong json
        ("/", "", "GET", {'foo': 'bar'}, None, {'content-type': 'abc'}, get_json, 'foo', ValueError),  #  wrong headers
