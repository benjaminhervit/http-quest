...
@pytest.mark.parametrize(
    ...
    [
        # query test
        (QuestState.LOCKED.value, [QuestState.LOCKED.value, "title", "locked", "", "", "No hints just yet"]),
        (QuestState.UNLOCKED.value, [QuestState.UNLOCKED.value, "title", "start", "quest", "", ["hint1", "hint2"]]),
        (QuestState.COMPLETED.value, [QuestState.COMPLETED.value, "title", "completed", "quest", "next", ["hint1", "hint2"]]),
        (QuestState.FAILED.value, [QuestState.FAILED.value, "title", "failed", "quest", "", ["hint1", "hint2"]]),
    ]
)
