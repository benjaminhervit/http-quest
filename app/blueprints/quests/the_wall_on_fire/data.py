...
def get_quest():
    return QuestData(
        ...
        """,
        quest="""We have to DELETE that wall of fire and the battle-proven way to break down a wall of fire, is through many repeated attacks. This is not something POSTMAN or any other client can handle. This requires reptilian or coffee induced powers (.... it's Python and JavaScript).
