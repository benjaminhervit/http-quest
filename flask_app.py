...
clues = {
    ...
    'accept_quest': f'Now, if you accept_the_quest, POST me an {answers["accept_quest"]}, your group_name, and the_answer at {routes["accept_quest"]}. \n FORM your words wisely.',
...
def accept_the_quest() ->str:
    ...
    has_group = 'group_name' in request.form
...
def the_throne_room():
    return f"""Inside {routes["the_throne"]} you see the legendary WoT throne and CRUD {routes['crown']}.
            ...
            #"""Now, standing in front of it there is only one thing left to do: PUT the /the_crown/on_your_group_name"""
...
@app.route('/the_crown/<string:group_name>', methods=['GET', 'POST', 'DELETE', 'PUT'])
def the_crown(group_name : str) -> str:
